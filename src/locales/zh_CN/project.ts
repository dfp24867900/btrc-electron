export default {
  ...
  node: {
    ...
    please_select_check_type: '请选择校验方式',
    please_select_operator: '请选择校验操作符',
    please_select_failure_strategy: '请选择失败策略',
    please_enter_statistics_name_the_alias_in_statistics_execute_sql:
      '请输入实际值名',
    please_enter_statistics_execute_sql: '请输入实际值计算SQL',
    please_select_target_connector_type: '',
    please_select_target_datasource: '请选择目标数据源',
    please_enter_target_table: '请输入目标表',
    ...
    please_select_logic_operator: '请选择逻辑操作符',
    please_enter_length_limit: '请输入字段长度限制',
    please_enter_regexp_pattern: '请输入正则表达式',
    please_enter_begin_time: '请输入起始时间',
    please_enter_deadline: '请输入截止时间',
    please_enter_datetime_format: '请输入时间格式',
    please_enter_enumeration: '请输入枚举值列表'
  }
}
